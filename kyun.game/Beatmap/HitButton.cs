    ...
    public class HitButton : IHitObj
    {
        ...
        public void Update(long Position, Vector2 ps)
        {
            ...
            if (isActive)
            {
                ...
                {
                    bool mouseDown = (MouseHandler.GetState().LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed) || (MouseHandler.GetState().RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed);
                    ...
                    bool mouseUp = MouseHandler.GetState().LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Released || MouseHandler.GetState().RightButton == Microsoft.Xna.Framework.Input.ButtonState.Released;

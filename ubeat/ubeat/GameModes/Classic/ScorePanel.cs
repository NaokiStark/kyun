...
namespace kyun.GameModes.Classic
{
    public class ScorePanel:ScreenBase
    {
        ...
        public ClassicModeScreen ClassicInstance;
        ...
        public ScorePanel()
        {
            ...
            ClassicInstance = ClassicModeScreen.GetInstance(); //mm?
            ...
            {
                Text = $" {ClassicInstance.Beatmap.Artist} - {ClassicInstance.Beatmap.Title} [{ClassicInstance.Beatmap.Version}]",
            ...
            BackgroundDim = ClassicInstance.BackgroundDim;
        ...
        {
            EffectsPlayer.PlayEffect(SpritesContent.Instance.Applause);
            Background = ClassicInstance.Background;

            mapNameLabel.Text = $" {ClassicInstance.Beatmap.Artist} - {ClassicInstance.Beatmap.Title} [{ClassicInstance.Beatmap.Version}]";
            scoreLabel.Text = $"{ClassicInstance._scoreDisplay.TotalScore.ToString("00000000")}";
            ...
            foreach(HitSingle hb in ClassicInstance.hitobjects)
            {
                ScoreType score;
                if (hb is HitHolder)
                {
            ...
            acclbl.Text = $"{((float)acc / (float)ClassicInstance.hitobjects.Count).ToString("0.0", System.Globalization.CultureInfo.InvariantCulture)}%";

...
namespace kyun.Audio.Effects
{
    public class TimePitchEff : ISampleProvider
    {
        //Shifter objects
        ...
        public TimePitchEff(ISampleProvider sourceProvider)
        ...
        public TimePitchEff(ISampleProvider sourceProvider, int fftSize, long osamp,
            float initialPitch)
        {

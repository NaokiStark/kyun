...
namespace kyun
{
    public class KyunGame : Game
    {
        ...
        public KyunGame()
        {
            ...
            string ubeatProcess = Process.GetCurrentProcess().ProcessName;
            DateTime lastComp = File.GetLastWriteTime(Path.Combine(Environment.CurrentDirectory, ubeatProcess+ ".exe"));
